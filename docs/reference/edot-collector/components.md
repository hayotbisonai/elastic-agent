...
These components are included in EDOT Collector version 9.2.4.

| Component | GitHub Repo | Support status | Version |
|:---|:---|:---|:---|
|***Extensions***||||
| [extensiontest](https://github.com/open-telemetry/opentelemetry-collector/tree/main/extension/extensiontest) | [OTel Core Repo](https://github.com/open-telemetry/opentelemetry-collector) | [Extended] | v0.141.0 |
